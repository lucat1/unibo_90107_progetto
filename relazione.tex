...
\begin{enumerate}
    ...
    \item \label{oploc3} Visualizzasgocciolire la capacità totale di un luogo (in media 6 volte al mese)
    \item \label{oploc4} Visualizzare i luoghi che soddisfano una capienza (in media 3 volte al mese)
...
\begin{tabularx}{\textwidth}{|X|>{\raggedright\arraybackslash}X|}
  ...
  \hline
  7 & 25 000 volte all'anno \\
  \hline
  8 & 17 500 volte all'anno\\
  \hline
  9 & 20 volte al mese \\
  \hline
  10 & 20 volte all'anno \\
  \hline
...
% TODO: capire se in queste tabelle devo contare anche le relazioni perche'
% sono in realta' campi della tabella entita', non tabelle relazioni separate
% quindi in sql non contano come un join in piu'.

\subsubsection*{Tavole degli accessi manenendo la ridondanza}
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
\hline
  \multicolumn{4}{|l|}{\textbf{Operazione \ref{oploc2} e \ref{oploc3}}} \\
\hline
\textbf{Concetto} & \textbf{Costrutto} & \textbf{Accessi} & \textbf{Tipo}\\
\hline
Evento & Entit\`a & 1 & L \\
...
\begin{tabularx}{\textwidth}{|X|X|X|X|}
\hline
  \multicolumn{4}{|l|}{\textbf{Operazione \ref{oploc4}}} \\
\hline
\textbf{Concetto} & \textbf{Costrutto} & \textbf{Accessi} & \textbf{Tipo}\\
\hline
Evento & Entit\`a & 1000 & L \\
\hline
Luogo & Entit\`a & 1000 & L \\
\hline
\end{tabularx}
