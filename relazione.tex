...
\subsubsection*{Visualizzare la percentuale media di biglietti venduti da un artista}
...
Risultato d'esempio per l'esecuzione dell'operazione \ref{percentage-sold-tickets-by-event}.
...
\subsubsection*{Visualizzare i posti prenotati da un evento}
